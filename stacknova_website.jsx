      ...
      <section className="relative overflow-hidden px-6 py-24 md:px-16">
        ...
        <div className="relative mx-auto max-w-6xl text-center">
          ...
          <div className="mt-8 flex flex-col items-center justify-center gap-4 sm:flex-row">
            <a href="product.html" className="inline-flex items-center justify-center px-8 py-3 rounded-2xl bg-cyan-500 text-black font-semibold shadow-xl">
              Get Started
            </a>
            <a href="#contact" className="inline-flex items-center justify-center px-8 py-3 rounded-2xl border border-white/20 bg-white/5 text-white font-semibold hover:border-cyan-400 hover:bg-cyan-500/10 transition">
              Contact Us
            </a>
          </div>
        </div>
