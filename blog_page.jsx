function BlogPage() {
  ...
  const posts = [
    { title: 'How AI Is Reshaping Modern Enterprises', summary: 'Explore how AI improvements are making business operations faster, smarter, and more secure.' },
    { title: 'Top Cloud Security Practices in 2026', summary: 'A guide on protecting your applications and data in modern cloud environments.' },
    { title: 'Why Scalable Software Matters for Growth', summary: 'Build products that can grow with your customers without breaking performance.' },
  ];
    ...
    <div className="min-h-screen bg-slate-950 text-white font-sans">
        ...
        <div className="max-w-6xl mx-auto flex items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-4">
            <div className="hidden md:flex gap-8 text-slate-300 items-center">
              ...
              <a href="blog.html" className="font-semibold text-white">Blog</a>
            </div>
            <button
      ...
      <section className="relative overflow-hidden px-6 py-24 md:px-16">
        ...
        <div className="relative mx-auto max-w-6xl text-center">
          <h1 className="text-4xl sm:text-5xl md:text-7xl font-bold">Latest Insights</h1>
          <p className="mt-6 text-slate-300 text-base sm:text-lg max-w-3xl mx-auto">
            Read about cloud innovation, AI automation, cybersecurity, and more from StackNova.
          </p>
      ...
      <section className="px-6 py-20 md:px-16">
        <div className="max-w-6xl mx-auto grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {posts.map((post) => (
            <div key={post.title} className="rounded-3xl border border-slate-800 bg-slate-900 p-8 shadow-xl">
              <h3 className="text-xl font-semibold text-cyan-300">{post.title}</h3>
              <p className="mt-4 text-slate-300 leading-7">{post.summary}</p>
            </div>
          ))}
        </div>
      </section>
